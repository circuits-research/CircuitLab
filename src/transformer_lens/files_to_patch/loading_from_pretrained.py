...
OFFICIAL_MODEL_NAMES = [
    "ansonisl/ShortSparseGPT2"
    "ansonisl/SparseGPT2",
    "ansonisl/SparseTinystories",
    "ansonisl/DenseTinystories",
    "ansonisl/SparseGPT2Finetuned",
    "gpt2",
    "gpt2-medium",
    "gpt2-large",
    "gpt2-xl",
...
def convert_hf_model_config(model_name: str, **kwargs):
    ...
    elif "ansonisl" in official_model_name.lower():
        hf_config = AutoConfig.from_pretrained(
            official_model_name,
            **kwargs,
        )
        architecture = "SparseTransformer"
    else:
    ...
    elif official_model_name.startswith("ansonisl"):
        cfg_dict = {
            "d_model": hf_config.d_model,
            "d_head": hf_config.d_head,
            "d_vocab": hf_config.d_vocab,
            "d_mlp": hf_config.d_mlp,
            "n_layers": hf_config.n_layers,
            "n_ctx": hf_config.n_ctx,
            "act_fn": hf_config.act_fn,
            "tokenizer_name": hf_config.tokenizer_name,
            "use_sparse_attn": hf_config.use_sparse_attn,
        }
    else:
    ...
    if not official_model_name.startswith("ansonisl"):
...
def get_pretrained_state_dict(
    ...
    **kwargs,
    ...
    if (
        ...
        or official_model_name.startswith("ArthurConmy")
        or official_model_name.startswith("Baidicoot")
        or official_model_name.startswith("ansonisl")
    ):
        api = HfApi()
