...
"""
File copied from SAE‑Lens (https://github.com/jbloomAus/SAELens),
MIT License (https://github.com/jbloomAus/SAELens/blob/master/LICENSE).
"""
...
def  load_model(
    ...
    if model_class_name == "HookedTransformer":
        ...
        force_to_device(model, torch.device(device))
...
def force_to_device(model: torch.nn.Module, device: torch.device):
