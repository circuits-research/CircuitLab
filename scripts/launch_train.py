...
def main():
    ...
    if world_size > 1:
        wandb_id_obj = [wandb_id]
        dist.broadcast_object_list(wandb_id_obj, src=0)
        wandb_id = wandb_id_obj[0]
    ...
    cfg = CLTTrainingRunnerConfig(
        ...
        model_name="gpt2",
        context_size=16,
        from_pretrained_path="/home/abir19/scratch/gpt2_multilingual_20_clt/zhb8w33x/final_17478656",
        d_in=768,
        expansion_factor=32,
        jumprelu_init_threshold=0.03,
        jumprelu_bandwidth=1.,
        ...
        decay_stable_steps=decay_stable_steps,
        log_to_wandb=True,
        wandb_project="gpt2-clt-feature-sharding",
        wandb_id=wandb_id,
        wandb_log_frequency=10,
        eval_every_n_wandb_logs=100,
        run_name=None,
