"""
Unit tests for CompressedActivationsStore.

Run with: pytest tests/training/test_compressed_activations_store.py -v
"""
...
class TestCompressionConfig:
    def test_default_config(self):
        ...
        assert config.per_layer_scale == True
    ...
    def test_custom_config(self):
        ...
        assert config.per_layer_scale == False
        assert config.symmetric == False
...
class TestSaveLoad:
    ...
    def test_save_without_tokens(self, sample_activations):
        ...
        try:
            ...
            assert metadata.get("has_tokens") == False
